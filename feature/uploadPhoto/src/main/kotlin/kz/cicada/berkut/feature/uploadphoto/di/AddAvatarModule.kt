...
import kz.cicada.berkut.feature.uploadphoto.utils.DefaultExternalRemoteImageStreamService
...
val addAvatarModule = module {
    ...
    factory<ExternalRemoteImageStreamService> {
        DefaultExternalRemoteImageStreamService(
            userPreferences = get(),
        )
    }
