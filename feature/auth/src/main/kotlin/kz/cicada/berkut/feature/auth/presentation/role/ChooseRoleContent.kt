...
import kz.cicada.berkut.feature.auth.R as authR
    ...
    Column(
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(id = authR.string.choice_role),
            ...
            CommonPrimaryButton(
                ...
                text = stringResource(id = authR.string.confirm),
    ...
    AppTheme {
        ChooseRoleContent(
            ...
            uiState = ChooseRoleUIState(
                roles = listOf(
                    RoleDvo(
                        title = VmRes.StrRes(authR.string.child),
                        icon = R.drawable.ic_lucky_avatar,
                        type = UserType.CHILD,
                    ), RoleDvo(
                        title = VmRes.StrRes(authR.string.parent),
